 ...
 */
// hacemos que nuestra clase implemente la interfaz Runnable, de la que debemos sobrescribir el método "run"
...
//Generamos un valor x de manera aleatoria en milisegundos
    ...
    public static void main(String[] args) {
        System.out.println("****Hilos con la interfaz Runnable****");
        //Clase super objeto =new constructor de la clase Hija(parametro para el constructor)   
        Thread h1 = new Thread(new EjRunnable("Hilo 1"));//Debemos instancias a´si cuando es con interfaz Runnable
        Thread h2 = new Thread(new EjRunnable("Hilo 2"));//Obervemos como pasamos el parametor al constructor
        //EjRunnable h3 = new EjRunnable("Hilo 3");//AsíNo da si es con interfaz Runnable, sólo si extendemos de Thread
